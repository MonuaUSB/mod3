        ...
        for (int i=0; i<arr.length; i++) {
            ...
            for (int j=0; j<arr.length; j++){
                if (j%2 == 0){
                    ...
                    sum2+=arr[j];}}
            if (sum > sum2){
                System.out.println("В домах с четными номерами проживает больше жителей. Сумма четных жителей: " + sum);}
            else if (sum2 > sum){
                System.out.println("В домах с нечетными номерами проживает больше жителей. Сумма нечетных жителей: " + sum2);}
        }
